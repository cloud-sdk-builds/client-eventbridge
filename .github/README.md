...
[`@aws-sdk/client-eventbridge`](https://www.npmjs.com/package/@aws-sdk/client-eventbridge/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y+xmvf8w4iGnTS3nhvpPL7UmruTqjFR+d9VDdukmi2d7U+SVLeFvNQBrw5+Qh3Xl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-eventbridge": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.256.0/index.min.mjs": "sha384-y+xmvf8w4iGnTS3nhvpPL7UmruTqjFR+d9VDdukmi2d7U+SVLeFvNQBrw5+Qh3Xl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-eventbridge/blob/refs/tags/3.256.0/LICENSE
```
