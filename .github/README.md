...
[`@aws-sdk/client-eventbridge`](https://www.npmjs.com/package/@aws-sdk/client-eventbridge/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XP++9i1+EtYMZQ381x3zce/EHUGyx3QB9dnGmmdS+kw+bKBpMXHq5fcZUinmXMsn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-eventbridge": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eventbridge@3.552.0/index.min.mjs": "sha384-XP++9i1+EtYMZQ381x3zce/EHUGyx3QB9dnGmmdS+kw+bKBpMXHq5fcZUinmXMsn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-eventbridge/blob/refs/tags/3.552.0/LICENSE
```
